...
const Main = () => {
  return (
    <div>
        ...
        <div className="container text-center">
          ...
          <div className="row pt-4 justify-content-center rounded">
            ...
            <div
              ...
              style={{ width: 300 }}
            >
              <i className="fas fa-user-md fa-4x py-2" />
            ...
            <div
              ...
              style={{ width: 300 }}
            >
              <i className="icon fas fa-map-marked-alt fa-4x py-2" />
      ...
      {/* Peduli bersama */}
      <section className="section text-center pt-5 pb-5" data-aos="fade-up">
      ...
      {/* Tim kami */}
      <section id="tim-kami" className="tim-kami">
        <div className="container py-5">
          ...
          <div className="row text-center mx-auto">
            <div className="col-12 col-sm-6 col-lg-3 mb-2 gap-5">
              <div className="card mx-auto pt-4 pb-3 border " style={{ width: 250 }}>
                <img
                  src={vicky}
